...
%global source0_sha512 62f448a6467f7838ff9b89dccff77d7a3e848e57647e9f5560ff6c0f788349392071ae666a2c2fbec02641003264970bc5782bcb27b20dea906a18701a7c0b5c
...
Source12: postgresql-setup-%{setup_version}.tar.gz
%global source12_sha512 4569e5ba83b16556312b89cd6762eb55902eb9265ce9ceb0e0fe18755e1ab7217ea748df465c4402e24d19b55b25702deab92030510dc722db8fcbc0cb639053
%global source12_url https://src.fedoraproject.org/repo/pkgs/postgresql/postgresql-setup-%{setup_version}.tar.gz/sha512/%{source12_sha512}/postgresql-setup-%{setup_version}.tar.gz
...
%if %external_libpq
BuildRequires: libpq-devel >= %version_postgres
%endif
...
%description
PostgreSQL code base with a patch applied to enable some additional functionality provided by the Babelfish extensions
...
* Mon Apr 15 2024 WiltonDB Software <info@wiltondb.com - 15.4.wiltondb3.3_7-1
- Update to wiltondb3.3-7

* Sat Mar 16 2024 WiltonDB Software <info@wiltondb.com - 15.4.wiltondb3.3_5-1
- Update to wiltondb3.3-5

* Sun Feb 11 2024 WiltonDB Software <info@wiltondb.com - 15.4.wiltondb3.3_4-1
...
* Mon May  8 2023 Alex Kasko <alex@staticlibs.net> - 15.2.BABEL_3_1-1
- Update to BABEL_3_1_STABLE (daa6078)

* Wed Feb 15 2023 Alex Kasko <alex@staticlibs.net> - 14.6.BABEL_2_3_0-3
- Update to the same upstream tag that was re-created on different commit

* Tue Jan 31 2023 Alex Kasko <alex@staticlibs.net> - 14.6.BABEL_2_3_0-2
- Add openssl dependency for certificate generation in postgresql-setup
- Better JDBC URL output from postgresql-setup

* Mon Jan 30 2023 Alex Kasko <alex@staticlibs.net> - 14.6.BABEL_2_3_0-1
- Update to BABEL_2_3_0
- Add allow_system_table_mods to initdb script
- Remove with-extra-version part of the version string

* Sat Jan  7 2023 Alex Kasko <alex@staticlibs.net> - 14.5.BABEL_2_2_1-1
